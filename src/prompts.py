...
def story_chunk_evaluation_prompt(chunk: StoryChunk, story: StoryData, criterion: Criterion) -> str:
    ...
    return f"""Evaluate the following visual novel game story according to the specified criteria and assign a score with a total of 10 for each criterion, where 10 is the best and 0 is the worst. Provide reasons for your scores. Make sure to output it in a MarkDown code block, i.e., between ```json and ```. {JSON_MAGIC_PHRASE}
